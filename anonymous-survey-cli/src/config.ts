...
// Config for Anonymous Survey CLI
...
export class StandaloneConfig implements Config {
  ...
  privateStateStoreName = 'anonymous-survey-private-state';
  logDir = path.resolve(currentDir, '..', 'logs', 'standalone', `${new Date().toISOString()}.log`);
  zkConfigPath = path.resolve(currentDir, '..', '..', 'contract', 'src', 'managed', 'anonymous-survey');
  generateDust = false;
}
